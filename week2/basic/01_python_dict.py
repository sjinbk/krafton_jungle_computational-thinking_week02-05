...
def find_above_average_students(students):
    ...
    scores = [students[x].get("score") for x in range(len(students))]
    pass
    ...
    above_average_students = [students[x].get("name") for x in range(len(students)) if students[x].get("score") >= average]
    pass
